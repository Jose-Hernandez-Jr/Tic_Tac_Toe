...
function placeXOrO(squareNumber) {
    //This conditoion ensures a square hasn'tbeen alreadyu.
    //The .some() method is used to check each element of the selectSquare array
    //tosee if it contains thge square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This variable retrieves the HTML element id that was clicked.
        let select = document.getElementById(squareNumber);
        //This coddition checks who 's turn it is.
        if (activePlayer === 'X') {
        ...
        //This calls a function to check for an win conditions.
        checkWinConditions();
        //This condition is for changing the active player.
        if (activePlayer === 'X') {
            //If active player is 'X' change it to 'O'.
            activePlayer = 'O';
            //I active player is anything other than 'X'
        } else {
        ...
        if (activePlayer === 'O') {
            //This function disables clicking for the computer turn.
            disableClick();
...
function checkWinConditions() {
    ...
    //This function checks if an array includes 3 strings. Itis used to check for
    //each win condition.
...
//This function makes our body element tempraily unclickable.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2 ) {
    //This line accesses our HTML canvas elemet.
    ...
    let x1 = coordX1,
        ...
        y2 = coordY2,
        //This variable stores temporary x axis data we we update in our animation loop.
        x = x1,
        //This variable stores temporary y axis data we we update in our animation loop.
        y = y1;
        ...
        function animationLineDrawing() {
            ...
            c.lineWidth = 10;
            //This mwthod sets the color of our line.
